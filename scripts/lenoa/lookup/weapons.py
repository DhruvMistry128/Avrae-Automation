...
-footer "{{ctx.prefix+ctx.alias }} lookup weapon <weapon name> | {{ctx.prefix+ctx.alias }} lookup weapon list || alias for Lenoa by chaoshyper, Henpus, Mister Man"